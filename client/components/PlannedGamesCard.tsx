        ...
        {games.length === 0 ? (
          ...
          <div className="space-y-6">
            {games.map((game, index) => (
              <div key={game.game_id} className="pb-6 border-b border-border/50 last:border-0 last:pb-0">
                <div className="space-y-3">
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <Badge variant="clickable" className="text-xs">
                      Play!
                    </Badge>
                  </div>
                  ...
                  <div className="ml-11 space-y-2">
                    <div className="flex items-center gap-2 text-sm text-muted-foreground">
                      ...
                      <span>Contestants: {game.contestants.map(c => c.firstName).join(", ")}</span>
                    </div>
